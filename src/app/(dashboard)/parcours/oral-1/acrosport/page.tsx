  ...
  return (
    <Box p={5} maxW="3/4" mx="auto" boxShadow="md">
      <Flex bg="teal.500" p={4} borderRadius="lg" align="center" justify="center">
        <Heading size="lg" color="white">Acrosport</Heading>
      </Flex>
      ...
      <VStack align="start" gap={4} mt={4} >
        ...
        <Box bg="teal.500" p={3} borderRadius="lg" w="full">
          <Heading size="md" color="white">7. Sécurité</Heading>
        </Box>
        ...
        <List.Root gap={2} pl={4}>
          <List.Item>
            ...
            <List.Root ps="5">
              ...
              <List.Item>Poser les appuis au-dessus des zones solues (au-dessus des segments tendus)</List.Item>
            </List.Root>
          </List.Item>
