    ...
    <Box p={5} maxW="3/4" mx="auto" boxShadow="md">
      ...
      <VStack align="start" gap={4} mt={4} >
        ...
        <List.Root ps="5">
          ...
          <List.Item>SA2 : 2 VS 1et 1 : un coureur réalise la course en entier pendant que dans le couloir à côté, un binôme effectue un relais. But : le relais doit aller plus vite que le coureur seul</List.Item>
