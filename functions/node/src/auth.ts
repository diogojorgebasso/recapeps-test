...
export const saveroletofirestore = functions.runWith({
    serviceAccount: "save-role-to-firestore-run@recapeps-test.iam.gserviceaccount.com", 
    ...
    try {
        ...
        info(`Role ${role} saved to user ${uid} successfully.`);
    } catch (err) {
